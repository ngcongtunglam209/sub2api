...
// The UserAddonFunc type is an adapter to allow the use of ordinary function as a Querier.
type UserAddonFunc func(context.Context, *ent.UserAddonQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f UserAddonFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.UserAddonQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.UserAddonQuery", q)
}

// The TraverseUserAddon type is an adapter to allow the use of ordinary function as Traverser.
type TraverseUserAddon func(context.Context, *ent.UserAddonQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseUserAddon) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseUserAddon) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.UserAddonQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.UserAddonQuery", q)
}
...
// The VIPTierFunc type is an adapter to allow the use of ordinary function as a Querier.
type VIPTierFunc func(context.Context, *ent.VIPTierQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f VIPTierFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.VIPTierQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.VIPTierQuery", q)
}

// The TraverseVIPTier type is an adapter to allow the use of ordinary function as Traverser.
type TraverseVIPTier func(context.Context, *ent.VIPTierQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseVIPTier) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseVIPTier) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.VIPTierQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.VIPTierQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.UserAddonQuery:
		return &query[*ent.UserAddonQuery, predicate.UserAddon, useraddon.OrderOption]{typ: ent.TypeUserAddon, tq: q}, nil
	...
	case *ent.VIPTierQuery:
		return &query[*ent.VIPTierQuery, predicate.VIPTier, viptier.OrderOption]{typ: ent.TypeVIPTier, tq: q}, nil
	default:
