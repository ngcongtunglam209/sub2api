...
func (s *FrontendServer) serveIndexHTML(c *gin.Context) {
	...
	// The branding identity this request renders under, resolved once by
	// middleware.HostBranding. Never the raw Host header: see HTMLCache.
	// Anything that resolved to nothing — the canonical host, an unknown host,
	// a domain with no override — shares the one default entry.
	cacheKey := branding.FromContext(c.Request.Context()).CacheKey()
	...
	rendered := renderIndexHTML(s.baseHTML, settingsJSON)
