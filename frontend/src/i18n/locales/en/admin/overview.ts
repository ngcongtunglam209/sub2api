export default {
    ...
    users: {
      ...
      vipTier: {
        ...
        nextTier: 'Next tier',
        assign: 'Assignment',
        automatic: 'Automatic grading',
        automaticHint: 'Follow spend; the tier lapses when it is not renewed.',
        tierSummary: 'Rate {rate}x · concurrency floor {concurrency}',
        pinWarning: 'A pinned tier ignores spend grading and never expires until released.',
        saved: 'VIP tier updated',
        saveFailed: 'Failed to update VIP tier',
        loadFailed: 'Failed to load VIP tier'
      },
