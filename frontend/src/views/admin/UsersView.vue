                ...
                >
                  <button
                    ...
                    :class="[
                      ...
                      isForcedVisibleColumn(col.key)
                        ...
                        : 'text-ink-secondary hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-dark-700'
                    ]"
                  ...
                  >
                    ...
                    <Icon
                      ...
                      name="check"
                      size="sm"
                      :class="isForcedVisibleColumn(col.key) ? 'text-ink-tertiary' : 'text-primary-500'"
                      :stroke-width="2"
                    />
                  </button>
                </div>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-username="{ value }">
            <span class="text-sm text-ink-secondary">{{ value || '-' }}</span>
          </template>
          ...
          <template #cell-notes="{ value }">
            <div class="max-w-xs">
              <span
                ...
                class="block truncate text-sm text-ink-secondary"
              >
          ...
          <template #cell-groups="{ row }">
            <div v-if="allGroups.length > 0" class="flex flex-col gap-1">
              ...
              >
                ...
                <span class="text-ink-secondary">{{ t('admin.users.exclusiveLabel') }}</span>
                ...
                >
                  ...
                  <div
                    ...
                    :key="g.id"
                    class="flex cursor-pointer items-center gap-2 px-3 py-2 text-ink-secondary transition-colors hover:bg-primary-50 hover:text-primary-600 dark:text-dark-200 dark:hover:bg-primary-900/30 dark:hover:text-primary-400"
              ...
              >
                <Icon name="globe" size="xs" class="h-3.5 w-3.5 text-ink-tertiary" />
                <span class="font-medium text-ink-secondary">{{ getUserGroups(row).publicGroups.length }}</span>
                <span class="text-ink-tertiary">{{ t('admin.users.publicLabel') }}</span>
                <!-- Tooltip: 向下弹出 -->
          ...
          <template #cell-subscriptions="{ row }">
            ...
            <span
              v-else
              class="inline-flex items-center gap-1.5 rounded-md bg-gray-50 px-2 py-1 text-xs text-ink-tertiary dark:bg-dark-700/50 dark:text-dark-500"
            >
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="[
                  'flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-secondary transition-colors',
                  row.status === 'active'
